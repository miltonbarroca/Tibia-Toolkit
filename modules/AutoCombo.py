...
# Título
title_label = tk.Label(root, text="Tibia Automation Toolkit", font=("Helvetica", 16))
title_label.pack(pady=10)

# Botão para iniciar o combo
iniciar_button = tk.Button(root, text="Iniciar Combo", command=iniciar_combo, width=20, height=2)
iniciar_button.pack(pady=5)

# Botão para pausar/retomar o combo
pausar_button = tk.Button(root, text="Pausar/Retomar Combo", command=pausar_combo, width=20, height=2)
pausar_button.pack(pady=5)

# Botão para finalizar o combo
finalizar_button = tk.Button(root, text="Finalizar Programa", command=finalizar_combo, width=20, height=2)
finalizar_button.pack(pady=5)

# Label para status
status_label = tk.Label(root, text="Aguardando...", font=("Helvetica", 12))
